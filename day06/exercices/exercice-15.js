...
let jsonString = '{"id":1, "titre":"Apprendre le JS", "vu":false}';
let cours = JSON.parse(jsonString);
cours.vu = true
let updatedjson = JSON.stringify(cours)
console.log("  final content:", updatedjson)